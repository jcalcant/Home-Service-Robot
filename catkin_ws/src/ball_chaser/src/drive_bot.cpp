...
// This function should publish the requested linear x and angular velocities to
// the robot wheel joints
    ...
    ball_chaser::DriveToTarget::Response& res)
{
  ...
  ROS_INFO("Drive Request received - linear_x:%1.2f, angular_z:%1.2f", linear_x, angular_z);
  ...
  res.message_feedback = "Velocities set - Linear X: " + std::to_string(linear_x) + " , Angular Z: " + std::to_string(angular_z);
...
int main(int argc, char** argv)
{
    ...
    // TODO: Delete the loop, move the code to the inside of the callback
    // function and make the necessary changes to publish the requested velocities
